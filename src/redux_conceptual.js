...
// The former are oblivious to React, should have not state, read only from props, write only via injected callbacks.
// The latter are coupled to react. They subscribe to events and dispatch actions to the store.
